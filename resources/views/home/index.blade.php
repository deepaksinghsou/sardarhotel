...
<link rel="stylesheet" type="text/css" href="{{ url('home/styles/bootstrap-4.1.2/bootstrap.min.css')}}">
<link href="{{ url('home/plugins/font-awesome-4.7.0/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="{{ url('home/plugins/OwlCarousel2-2.3.4/owl.carousel.css')}}">
<link rel="stylesheet" type="text/css" href="{{ url('home/plugins/OwlCarousel2-2.3.4/owl.theme.default.css')}}">
<link rel="stylesheet" type="text/css" href="{{ url('home/plugins/OwlCarousel2-2.3.4/animate.css')}}">
<link href="{{ url('home/plugins/jquery-datepicker/jquery-ui.css')}}" rel="stylesheet" type="text/css">
	...
	<div class="menu trans_400 d-flex flex-column align-items-end justify-content-start">
		...
		<div class="menu_extra">
			...
			<div class="menu_phone d-flex flex-row align-items-center justify-content-center">
				<img src="{{ url('home/images/phone-2.png')}}" alt="">
				<span>0183-12345678</span>
			</div>
		</div>
	</div>
	...
	<div class="home">
		<div class="home_slider_container">
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Slide -->
				<div class="slide">
					<div class="background_image" style="background-image:url({{ url('home/images/index_1.jpg')}})"></div>
			...
			<div class="row">
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box d-flex flex-column align-items-center justify-content-start text-center">
						<div class="icon_box_icon"><img src="{{ url('home/images/icon_1.svg')}}" class="svg" alt="https://www.flaticon.com/authors/monkik"></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box d-flex flex-column align-items-center justify-content-start text-center">
						<div class="icon_box_icon"><img src="{{ url('home/images/icon_2.svg')}}" class="svg" alt="https://www.flaticon.com/authors/monkik"></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box d-flex flex-column align-items-center justify-content-start text-center">
						<div class="icon_box_icon"><img src="{{ url('home/images/icon_3.svg')}}" class="svg" alt="https://www.flaticon.com/authors/monkik"></div>
		...
		<div class="gallery_slider_container">
			<div class="owl-carousel owl-theme gallery_slider">
				...
				<div class="gallery_item">
					<div class="background_image" style="background-image:url({{ url('home/images/gallery_1.jpg')}})"></div>
					<a class="colorbox" href="images/gallery_1.jpg"></a>
				</div>

				<!-- Slide -->
				<div class="gallery_item">
					<div class="background_image" style="background-image:url({{ url('home/images/gallery_2.jpg')}})"></div>
					<a class="colorbox" href="images/gallery_2.jpg"></a>
				</div>

				<!-- Slide -->
				<div class="gallery_item">
					<div class="background_image" style="background-image:url({{ url('home/images/gallery_3.jpg')}})"></div>
					<a class="colorbox" href="images/gallery_3.jpg"></a>
				</div>

				<!-- Slide -->
				<div class="gallery_item">
					<div class="background_image" style="background-image:url({{ url('home/images/gallery_4.jpg')}})"></div>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="about_images d-flex flex-row align-items-center justify-content-between flex-wrap">
						<img src="{{ url('home/images/about_1.png')}}" alt="">
						<img src="{{ url('home/images/about_2.png')}}" alt="">
						<img src="{{ url('home/images/about_3.png')}}" alt="">
					</div>
				</div>
			</div>
		</div>
					...
					<div class="testimonials_slider_container">
						...
						<div class="owl-carousel owl-theme test_slider">
							...
							<div  class="test_slider_item text-center">
								...
								<div class="testimonial_image"><img src="{{ url('home/images/user_1.jpg')}}" alt=""></div>
							...
							<div  class="test_slider_item text-center">
								...
								<div class="testimonial_image"><img src="{{ url('home/images/user_2.jpg')}}" alt=""></div>
							...
							<div  class="test_slider_item text-center">
								...
								<div class="testimonial_image"><img src="{{ url('home/images/user_3.jpg')}}" alt=""></div>
					...
					<div class="booking_slider_container">
						<div class="owl-carousel owl-theme booking_slider">
							...
							<div class="booking_item">
								<div class="background_image" style="background-image:url({{ url('home/images/booking_1.jpg')}})"></div>
							...
							<!-- Slide -->
							<div class="booking_item">
								<div class="background_image" style="background-image:url({{ url('home/images/booking_2.jpg')}})"></div>
								<div class="booking_overlay trans_200"></div>
								<div class="booking_price">$120/Night</div>
							...
							<!-- Slide -->
							<div class="booking_item">
								<div class="background_image" style="background-image:url({{ url('home/images/booking_3.jpg')}})"></div>
								<div class="booking_overlay trans_200"></div>
								<div class="booking_price">$120/Night</div>
		...
		<div class="blog_slider_container">
			<div class="owl-carousel owl-theme blog_slider">
				...
				<div class="blog_slide">
					<div class="background_image" style="background-image:url({{ url('home/images/index_blog_1.jpg')}})"></div>
				...
				<!-- Slide -->
				<div class="blog_slide">
					<div class="background_image" style="background-image:url({{ url('home/images/index_blog_2.jpg')}})"></div>
					<div class="blog_content">
						<div class="blog_date"><a href="#">Oct 20, 2018</a></div>
				...
				<!-- Slide -->
				<div class="blog_slide">
					<div class="background_image" style="background-image:url({{ url('home/images/index_blog_3.jpg')}})"></div>
					<div class="blog_content">
						<div class="blog_date"><a href="#">Oct 20, 2018</a></div>
				...
				<div class="row footer_row">
					...
					<div class="col-lg-3">
						<div class="certificates d-flex flex-row align-items-start justify-content-lg-between justify-content-start flex-lg-nowrap flex-wrap">
							<div class="cert"><img src="{{ url('home/images/cert_1.png')}}" alt=""></div>
							<div class="cert"><img src="{{ url('home/images/cert_2.png')}}" alt=""></div>
						</div>
					</div>
				</div>
			</div>
...
<script src="{{ url('home/plugins/OwlCarousel2-2.3.4/owl.carousel.js')}}"></script>
...
<script src="{{ url('home/plugins/jquery-datepicker/jquery-ui.js')}}"></script>
